...
- Create Angular project with ng: `ng new yardoptimization.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`yardoptimization.client.esproj`).
